...
public class ContainerPoleLight extends ContainerBulbs {

    protected TileEntityPoleLight tileEntityPoleLight;

    public ContainerPoleLight(InventoryPlayer inventoryPlayer, TileEntityPoleLight tileEntity){
        tileEntityPoleLight = tileEntity;
        addSlotToContainer(new SlotBulbs(tileEntityPoleLight, 0, 107, 37));
    ...
    public void onContainerClosed(EntityPlayer player) {
        ...
        tileEntityPoleLight.closeInventory();
    }

    @Override
    public boolean canInteractWith(EntityPlayer player) {
        return tileEntityPoleLight.isUseableByPlayer(player);
    }
