...
public class ContainerBlockLight extends ContainerBulbs {

    protected TileEntityBlockLight tileEntityBlockLight;

    public ContainerBlockLight(InventoryPlayer inventoryPlayer, TileEntityBlockLight tileEntity){
        tileEntityBlockLight = tileEntity;
        addSlotToContainer(new SlotBulbs(tileEntityBlockLight, 0, 107, 37));
    ...
    public void onContainerClosed(EntityPlayer player) {
        ...
        tileEntityBlockLight.closeInventory();
    }

    @Override
    public boolean canInteractWith(EntityPlayer player) {
        return tileEntityBlockLight.isUseableByPlayer(player);
    }
