...
public class ContainerOfficeLight2 extends ContainerBulbs {

    protected TileEntityOfficeLight2 tileEntityOfficeLight2;

    public ContainerOfficeLight2(InventoryPlayer inventoryPlayer, TileEntityOfficeLight2 tileEntity){
        tileEntityOfficeLight2 = tileEntity;
        addSlotToContainer(new SlotBulbs(tileEntityOfficeLight2, 0, 107, 37));
    ...
    public void onContainerClosed(EntityPlayer player) {
        ...
        tileEntityOfficeLight2.closeInventory();
    }

    @Override
    public boolean canInteractWith(EntityPlayer player) {
        return tileEntityOfficeLight2.isUseableByPlayer(player);
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer entityPlayer, int slotIndex) {
        ...
        SlotBulbs officeLight2Slot = (SlotBulbs) inventorySlots.get(0);
        if (slot != null && slot.getHasStack()) {
            ...
            if (!officeLight2Slot.getHasStack() && slotIndex > 0 && itemStack.getItem() instanceof ItemBulbNormal) {
                ...
                officeLight2Slot.putStack(newItemStack);
                officeLight2Slot.onSlotChanged();
            ...
            } else if (officeLight2Slot.getHasStack() && slotIndex == 0) {
