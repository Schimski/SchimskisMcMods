...
public class ContainerStealthLight extends ContainerBulbs {

    protected TileEntityStealthLight tileEntityStealthLight;

    public ContainerStealthLight(InventoryPlayer inventoryPlayer, TileEntityStealthLight tileEntity){
        tileEntityStealthLight = tileEntity;
        addSlotToContainer(new SlotBulbs(tileEntityStealthLight, 0, 107, 37));
    ...
    public void onContainerClosed(EntityPlayer player) {
        ...
        tileEntityStealthLight.closeInventory();
    }

    @Override
    public boolean canInteractWith(EntityPlayer player) {
        return tileEntityStealthLight.isUseableByPlayer(player);
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer entityPlayer, int slotIndex) {
        ...
        SlotBulbs stealthLightSlot = (SlotBulbs) inventorySlots.get(0);
        if (slot != null && slot.getHasStack()) {
            ...
            if (!stealthLightSlot.getHasStack() && slotIndex > 0 && itemStack.getItem() instanceof ItemBulbNormal) {
                ...
                stealthLightSlot.putStack(newItemStack);
                stealthLightSlot.onSlotChanged();
            ...
            } else if (stealthLightSlot.getHasStack() && slotIndex == 0) {
