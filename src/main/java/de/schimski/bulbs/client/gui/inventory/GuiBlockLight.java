...
public class GuiBlockLight extends GuiContainer{

    private static final ResourceLocation texture = new ResourceLocation(Reference.MOD_ID, "textures/gui/thinLight.png");

    public GuiBlockLight(InventoryPlayer inventoryPlayer, TileEntityBlockLight tileEntityBlockLight) {
        super(new ContainerBlockLight(inventoryPlayer, tileEntityBlockLight));
        this.xSize = 229;
        this.ySize = 184;
    }
