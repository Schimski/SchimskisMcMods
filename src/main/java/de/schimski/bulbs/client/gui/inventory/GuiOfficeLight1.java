...
public class GuiOfficeLight1 extends GuiContainer{

    private static final ResourceLocation texture = new ResourceLocation(Reference.MOD_ID, "textures/gui/thinLight.png");

    public GuiOfficeLight1(InventoryPlayer inventoryPlayer, TileEntityOfficeLight1 tileEntityOfficeLight1) {
        super(new ContainerOfficeLight1(inventoryPlayer, tileEntityOfficeLight1));
        this.xSize = 229;
        this.ySize = 184;
    }
