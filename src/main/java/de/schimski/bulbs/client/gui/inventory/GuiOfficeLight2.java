...
import de.schimski.bulbs.inventory.ContainerOfficeLight2;
...
public class GuiOfficeLight2 extends GuiContainer{

    private static final ResourceLocation texture = new ResourceLocation(Reference.MOD_ID, "textures/gui/thinLight.png");

    public GuiOfficeLight2(InventoryPlayer inventoryPlayer, TileEntityOfficeLight2 tileEntityOfficeLight2) {
        super(new ContainerOfficeLight2(inventoryPlayer, tileEntityOfficeLight2));
        this.xSize = 229;
        this.ySize = 184;
    }
