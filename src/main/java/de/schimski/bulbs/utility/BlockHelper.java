...
public class BlockHelper {
    ...
    public static boolean[] compareBlocks6Sides(World world, int x, int y, int z, String unlocalizedName, byte tileState) {
    ...
    public static boolean[] compareBlocks2Sides(World world, int x, int y, int z, String unlocalizedName, byte tileState) {
