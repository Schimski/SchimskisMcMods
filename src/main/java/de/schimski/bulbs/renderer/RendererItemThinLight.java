...
public class RendererItemThinLight implements IItemRenderer {

    protected ModelThinLightX32 blockModel;
    protected ResourceLocation blockTexture;
    TileEntitySpecialRenderer render;

    public RendererItemThinLight() {
        blockModel = new ModelThinLightX32();
        blockTexture = new ResourceLocation(Reference.MOD_ID.toLowerCase(), "textures/models/thinLight/thinLightWhiteX32.png");
