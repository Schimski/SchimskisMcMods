...
public class RendererItemOfficeLight2 implements IItemRenderer {

    protected ModelOfficeLight2X32 blockModel;
    protected ResourceLocation blockTexture;
    TileEntitySpecialRenderer render;

    public RendererItemOfficeLight2() {
        blockModel = new ModelOfficeLight2X32();
        blockTexture = new ResourceLocation(Reference.MOD_ID.toLowerCase(), "textures/models/officeLight2/officeLight2WhiteX32.png");
        render = new RendererOfficeLight2();
