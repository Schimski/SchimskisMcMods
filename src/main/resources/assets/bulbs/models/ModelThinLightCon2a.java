...
public class ModelThinLightCon2a extends ModelBase
{
  //fields
  ...
  public ModelThinLightCon2a()
  {
    textureWidth = 64;
    textureHeight = 32;
    
      ThinLightBottom = new ModelRenderer(this, 0, 0);
      ThinLightBottom.addBox(-8F, -1F, -2F, 10, 1, 4);
      ...
      ThinLightLight = new ModelRenderer(this, 0, 22);
      ThinLightLight.addBox(-8.5F, -1.5F, -1.5F, 10, 1, 3);
      ...
      ThinLightLight2.addBox(-1.5F, -1.5F, -8.5F, 3, 1, 7);
