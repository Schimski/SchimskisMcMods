...
public class ModelGridLightX32 extends ModelBase
{
  //fields
  ...
  public ModelGridLightX32()
  {
    ...
    textureHeight = 192;
      ...
      Light = new ModelRenderer(this, 62, 27);
      Light.addBox(-8F, 0F, -8F, 16, 2, 16);
      Light.setRotationPoint(0F, 20F, 0F);
      Light.setTextureSize(128, 128);
      Light.mirror = true;
      setRotation(Light, 0F, 0F, 0F);
      Alpha = new ModelRenderer(this, 0, 50);
      Alpha.addBox(-9F, 0F, -9F, 18, 3, 18);
      Alpha.setRotationPoint(0F, 19F, 0F);
      Alpha.setTextureSize(128, 128);
      Alpha.mirror = true;
      setRotation(Alpha, 0F, 0F, 0F);
      Cage = new ModelRenderer(this, 0, 26);
      Cage.addBox(-10F, 0F, -10F, 20, 4, 20);
      Cage.setRotationPoint(0F, 18F, 0F);
      Cage.setTextureSize(128, 128);
      Cage.mirror = true;
